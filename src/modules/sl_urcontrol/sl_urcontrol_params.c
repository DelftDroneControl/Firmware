...
PARAM_DEFINE_FLOAT(SL_INDI_CHI,90);
PARAM_DEFINE_FLOAT(SL_INDI_ATILT,0.0);
PARAM_DEFINE_FLOAT(SL_INDI_G2, 0.065);
PARAM_DEFINE_FLOAT(SL_INDI_KP, 200.0);
PARAM_DEFINE_FLOAT(SL_INDI_KD, 30.0);
PARAM_DEFINE_FLOAT(SL_INDI_ALT_KP, 10.0);
PARAM_DEFINE_FLOAT(SL_INDI_ALT_KD, 3.0);
...
PARAM_DEFINE_FLOAT(SL_MAG_XI, 0.04);
PARAM_DEFINE_FLOAT(SL_MAG_YI, -0.18);
PARAM_DEFINE_FLOAT(SL_MAG_ZI, 0.46);
PARAM_DEFINE_FLOAT(SL_MAG_SHIFT, 1.6);
...
PARAM_DEFINE_INT32(SL_MANUAL_ALT, 0);
