...
PARAM_DEFINE_FLOAT(SL_QP_KI, 1.0);
PARAM_DEFINE_FLOAT(SL_QP_KD, 20.0);
PARAM_DEFINE_FLOAT(SL_QP_KDD, 1.0);
...
PARAM_DEFINE_FLOAT(SL_QP_PA_THRESH, 0.7);

// FAIL PROTECTION
PARAM_DEFINE_INT32(SL_FAIL_PROT, 0);
PARAM_DEFINE_FLOAT(SL_FAIL_THRESH, -1.0);
