/*
 * /home/bramsvs/src/monorepo/simulink_model/.codeGenCache/slprj/grt/_sharedutils/normcdf_RuozKmPV.cpp
 *
...
real_T normcdf_RuozKmPV(real_T x, real_T varargin_1, real_T varargin_2)
{
  real_T p;
  real_T b_x;
  real_T absx;
  ...
  if (varargin_2 == 0.0) {
    p = !(x < varargin_1);
  } else if (varargin_2 > 0.0) {
    b_x = -((x - varargin_1) / varargin_2) / 1.4142135623730951;
    ...
    if (rtIsNaN(b_x)) {
      ...
      if (absx < 1.3877787807814457E-17) {
        ...
        z = b_x * b_x;
        if (b_x < 0.25) {
          absx = 1.0 - (b_x * (((((z * -2.3763016656650163E-5 +
            -0.0057702702964894416) * z + -0.02848174957559851) * z +
            -0.3250421072470015) * z + 0.12837916709551256) / (((((z *
            -3.9602282787753681E-6 + 0.00013249473800432164) * z +
            0.0050813062818757656) * z + 0.0650222499887673) * z +
            0.39791722395915535) * z + 1.0)) + b_x);
        } else {
          absx = 0.5 - (b_x * (((((z * -2.3763016656650163E-5 +
            -0.0057702702964894416) * z + -0.02848174957559851) * z +
            -0.3250421072470015) * z + 0.12837916709551256) / (((((z *
            -3.9602282787753681E-6 + 0.00013249473800432164) * z +
            0.0050813062818757656) * z + 0.0650222499887673) * z +
            0.39791722395915535) * z + 1.0)) + (b_x - 0.5));
        }
      }
    } else if (absx < 1.25) {
      if (b_x >= 0.0) {
        absx = 0.15493708848953247 - (((((((absx - 1.0) * -0.0021663755948687908
          ...
          1.0) + 0.071828654414196266) * (absx - 1.0) + 0.540397917702171) *
          (absx - 1.0) + 0.10642088040084423) * (absx - 1.0) + 1.0);
      } else {
        absx = ((((((((absx - 1.0) * -0.0021663755948687908 +
                      0.035478304325618236) * (absx - 1.0) +
                     -0.11089469428239668) * (absx - 1.0) + 0.31834661990116175)
                   * (absx - 1.0) + -0.37220787603570132) * (absx - 1.0) +
                  0.41485611868374833) * (absx - 1.0) + -0.0023621185607526594) /
                (((((((absx - 1.0) * 0.011984499846799107 + 0.013637083912029051)
                     * (absx - 1.0) + 0.12617121980876164) * (absx - 1.0) +
                    0.071828654414196266) * (absx - 1.0) + 0.540397917702171) *
                  (absx - 1.0) + 0.10642088040084423) * (absx - 1.0) + 1.0) +
      ...
      z = std::floor(z * 2.097152E+6) / 2.097152E+6 * rt_powd_snf(2.0, (real_T)e);
